...
1. **GitHub Private Vulnerability Reporting** (preferred) - go to the [Security tab](https://github.com/srmarohit/prime-nestjs/security/advisories/new) and submit a private advisory.
2. **Email** - send details to srmarohit@gmail.com.
